...
/**
   抛物线结束 的回调
 */
typedef void(^ThrowLineAnimationFinished)(void);

@interface SCThrowLineTools : NSObject
...
/***/
@property (nonatomic, copy) ThrowLineAnimationFinished  animationFinishedBlock;
